...
public class CollectDetailInfo extends BaseDomain {
    private Long              id;
    ...
    public Long getInMechMoney() {
        return inMechMoney;
    }

    public void setInMechMoney(Long inMechMoney) {
        this.inMechMoney = inMechMoney;
    }

    public Long getInFee() {
        return inFee;
    }

    public void setInFee(Long inFee) {
        this.inFee = inFee;
    }

    public Long getInBail() {
        return inBail;
    }

    public void setInBail(Long inBail) {
        this.inBail = inBail;
    }
    ...
    public Long getOutMechMoney() {
        return outMechMoney;
    }

    public void setOutMechMoney(Long outMechMoney) {
        this.outMechMoney = outMechMoney;
    }
