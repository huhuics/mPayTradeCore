...
/**
 * 将人民币由数字转换成汉语文字<br>
 * 注意：待转换的金额最多只能精确到小数点后面两位，如果有三位，将进行四舍五入<br>
 * 如3.12转换结果为叁元壹角贰分<br>3.123转换结果也是叁元壹角贰分<br>而3.125转换结果是叁元壹角叁分
 * @author HuHui
 * @version $Id: RMBUtil.java, v 0.1 2016年6月22日 下午11:04:32 HuHui Exp $
 */
