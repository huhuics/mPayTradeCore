 ...
 * 格式化生成结算中心的ID<br>
 * <ul>
 * <li>结算中心订单号=收单机构号+商户订单号。在结算中心全局唯一</li>
...
public class FormaterUtil {
     ...
     * 生成结算中心订单号
     */
    public static String tradeNoFormat(String acquirerId, String outTradeNo) {
        return new StringBuilder(acquirerId).append(outTradeNo).toString();
    }
